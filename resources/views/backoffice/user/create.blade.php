    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex flex-wrap align-items-center justify-content-end gap-2">
                <a href="{{ route('user.index') }}" type="button" class="btn btn-sm btn-danger radius-8 d-inline-flex align-items-center gap-1">
                    <iconify-icon icon="material-symbols:cancel-outline" class="text-xl"></iconify-icon>
                    Cancel
                </a>
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="#">
                                        ...
                                        <div class="d-flex align-items-center justify-content-center gap-3">
                                            <a href="{{ route('user.index') }}" type="button" class="border border-danger-600 bg-hover-danger-200 text-danger-600 text-md px-56 py-11 radius-8">
                                                Cancel
                                            </a>
